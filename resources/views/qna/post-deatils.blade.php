                                    ...
                                    @foreach ($pinnedJawaban->concat($otherJawaban) as $jawaban)
                                        ...
                                        @if ($jawaban->pinned)
                                            ...
                                            <form action="/qna7/{{ $jawaban->id }}" method="post">
                                                @csrf
                                                <input type="hidden" class="colomTombol2" name="jawaban_id" value="{{ $jawaban->id }}">
                                            
                                                    <button type="submit" class="btn btn-primary" name="vote" value="up">Vote Up ({{ $jawaban->vote_up }})</button>
                                            
                                                    <button type="submit" class="btn btn-danger delete-comment-button" name="vote" value="down">Vote Down</button>
                                            </form>
                                                <br>
                                                <br>
                                            </div>
