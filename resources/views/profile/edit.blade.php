...
<input class="form-control" id="inputOrgName" name="id_r_sekolah" type="text" placeholder="Sekolah" value="{{Auth::user()->id_r_sekolah}}">
</div>
...
<div class="col-md-6">
    ...
    <input class="form-control" id="inputPhone" name="recovery_token" type="text" value="{{Auth::user()->recovery_token}}" readonly>
    </div>
