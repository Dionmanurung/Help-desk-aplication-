...
Route::get('/lupapassword2', function () {
...
// Route::post('/qna/{id}', [qnaController::class, 'voteUp'])->middleware('auth');
// Route::post('/qna/{id}', [qnaController::class, 'voteDown'])->middleware('auth');


// Route::post('/qna/{id}', [qnaController::class, 'detail']);
// Route::post('/qna/{id}', [komentar::class, 'answer'])->middleware('auth');
// Route::post('/qna/{id}', [Komentar2Controller::class, 'komentar'])->name('komentar.komentar')->middleware('auth');
// Route::get('/qna/{id}/komentar', [Komentar2Controller::class, 'showPopup'])->middleware('auth')->name('komentar.popup');
// Route::post('/qna/{id}', [qnaController::class, 'Pin'])->middleware('auth');

// // Rute untuk menyimpan komentar dari popup
// Route::post('/qna/{id}/komentar', [Komentar2Controller::class, 'store'])->middleware('auth')->name('komentar.store');
